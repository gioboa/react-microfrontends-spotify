...
export default () => {
	return <div className='flex h-24 w-full bg-dark border-t border-t-dark-3 fixed bottom-0 left-0'>
		<div className='flex-1' />
		<div className='flex-1 flex justify-center items-center flex-col'>
			<div className='flex justify-center items-center'>
				<svg
					id=''
					className='text-dark-2 mr-6'
					style={{
						height: '1em',
						fontSize: '18',
						verticalAlign: '-.125em',
			...
			<div className='w-full flex mt-4'>
				<span className='text-dark-1 text-xs mr-2'>0:00</span>
				<div className='h-1 w-full rounded-md self-center bg-dark-2' />
				<span className='text-dark-1 text-xs ml-2'>0:00</span>
			</div>
		</div>
		<div className='flex-1 flex justify-end items-center pr-6'>
			<svg
				id=''
				className='text-dark-1 mr-6'
				style={{
					height: '1em',
					fontSize: '16',
					verticalAlign: '-.125em',
			...
			<div className='h-1 w-24 rounded-md self-center bg-white' />
		</div>
	</div>
};
